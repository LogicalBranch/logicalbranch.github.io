/* jshint ignore:start */
/* PrismJS 1.17.1 https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+git+go+json+markup-templating+perl+php+pug+python+rust+sass+scss+typescript */
